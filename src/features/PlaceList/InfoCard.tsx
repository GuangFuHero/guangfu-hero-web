          ...
          <div className="flex flex-col gap-2">
            {place.contact_phone === '-' ? (
              <div className="flex gap-2 items-center whitespace-pre-wrap">
                <Image src={getAssetPath('/icon/people_icon.svg')} alt="" width={20} height={20} />
                <Typography fontSize={16} fontWeight={400}>
                  {displayContact.replace(/^"|"$/g, '')}
                </Typography>
              </div>
            ) : isContactUrl === false ? (
              <div
                  ...
                  <div className="grid grid-cols-[80px_1fr] gap-4">
                    ...
                    <div className="whitespace-pre-wrap">
                      <a
                        key={place.contact_phone}
                        href={displayContact}
                        className="flex gap-2 items-center whitespace-pre-wrap cursor-pointer text-[var(--secondary)]"
                        target="_blank"
                        rel="noopener noreferrer"
                        title="點擊開啟連結"
                      >
